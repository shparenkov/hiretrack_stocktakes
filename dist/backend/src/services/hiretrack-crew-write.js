...
exports.runCrewOdbcWrite = runCrewOdbcWrite;
exports.assignCrewPosition = assignCrewPosition;
const child_process_1 = require("child_process");
const path_1 = __importDefault(require("path"));
function resolveBridgePath() {
    return path_1.default.resolve(process.cwd(), 'backend', 'python', 'hiretrack_crew_write.py');
}
function runCrewOdbcWrite(request) {
...
async function assignCrewPosition(params) {
    return runCrewOdbcWrite({ operation: 'assign-position', ...params });
}
