...
exports.resolveTicketsFrontendDistPath = resolveTicketsFrontendDistPath;
exports.resolveTicketsFrontendIndexPath = resolveTicketsFrontendIndexPath;
exports.renderBitrixTicketsAppShell = renderBitrixTicketsAppShell;
exports.renderFrontendBuildMissingPage = renderFrontendBuildMissingPage;
exports.renderStocktakeHistoryPage = renderStocktakeHistoryPage;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
const stocktake_history_page_1 = require("./stocktake-history-page");
function resolveTicketsAppRoot() {
    const candidates = [
        path_1.default.resolve(__dirname, '..', '..', '..'),
        path_1.default.resolve(__dirname, '..', '..', '..', '..'),
    ];
    const matched = candidates.find((candidate) => fs_1.default.existsSync(path_1.default.join(candidate, 'frontend')));
    return matched || candidates[candidates.length - 1];
}
function resolveTicketsFrontendDistPath() {
    return path_1.default.join(resolveTicketsAppRoot(), 'frontend', 'dist');
}
function resolveTicketsFrontendIndexPath() {
    return path_1.default.join(resolveTicketsFrontendDistPath(), 'index.html');
}
function renderBitrixTicketsAppShell(options) {
...
function renderFrontendBuildMissingPage() {
    return `<!doctype html>
<html lang="ru">
<head>
  <meta charset="utf-8">
...
function renderStocktakeHistoryPage() {
    return (0, stocktake_history_page_1.renderDenseStocktakeHistoryPage)();
}
